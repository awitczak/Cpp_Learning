// destructors are used for class object deletion, they have the same name as the class with a ~ sign before their name, similar to constructors - no return type
